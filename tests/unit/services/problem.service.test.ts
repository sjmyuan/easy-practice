  ...
  describe('generateSessionQueue', () => {
    it('should include all problems when no statistics exist', async () => {
      ...
      const mockProblemSets = [
        { id: 'ps1', name: 'Addition', type: 'addition', enabled: true, createdAt: Date.now() },
      ];
    ...
    it('should only include problems from enabled problem sets', async () => {
      const mockProblemSets = [
        { id: 'ps1', name: 'Addition Set 1', type: 'addition', enabled: true, createdAt: Date.now() },
        { id: 'ps2', name: 'Addition Set 2', type: 'addition', enabled: false, createdAt: Date.now() },
      ];

      const mockProblems = [
        { id: 'p1', problemSetId: 'ps1', problem: '1 + 1', answer: '2', createdAt: Date.now() },
        { id: 'p2', problemSetId: 'ps2', problem: '2 + 2', answer: '4', createdAt: Date.now() },
      ];
